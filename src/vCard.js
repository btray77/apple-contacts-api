// Original code from andrewppace at github: https:?/github.com/andrewppaced/vcard-json
// Implements vCard3.0 spec
var vCard = {};

vCard.generate = function(json) {
...
var parse_params = function(string) {
...
var parse_nickname = function(json) {
...
var parse_mailer = function(json) {
    var k, mailer, v, _ref;
    mailer = {};
    if (json.group) {
...
var parse_categories = function(json) {
...
var parse_prodid = function(json) {
    var prodid;
    prodid = {};
    if (json.group) {
...
var parse_sort_string = function(json) {
...
var generate_nickname = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_photo = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_bday = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_adr = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_label = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_tel = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_email = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_mailer = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_geo = function(json) {
    var string;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_title = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_role = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_logo = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_org = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_categories = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_note = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_prodid = function(json) {
    var string;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_rev = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_sort_string = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_sound = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_uid = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_url = function(json) {
    var string;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_class = function(json) {
    var string;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
...
var generate_key = function(json) {
    var k, string, v, _ref;
    string = "";
    if (json.group) {
      string += "" + json.group + ".";
